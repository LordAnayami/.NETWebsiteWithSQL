...
/* Created on:     2021-10-23 17:20:19                          */
/*==============================================================*/
...
create table DZIALKI (
   NR_Dzialki           numeric              identity,
   NR_Klient            numeric              null,
   NR_Zlec              numeric              null,
...
/*==============================================================*/
create table OSNOWA (
   NR_Osnowy            numeric              identity,
   NR_Dzialki           numeric              null,
   NR_Geo               numeric              not null,
...
alter table DZIALKI
   add constraint FK_DZIALKI_KLIENTDZI_KLIENT foreign key (NR_Klient)
      references KLIENT (NR_Klient)
go

alter table DZIALKI
   add constraint FK_DZIALKI_ZLECDZIAL_ZLECENIE foreign key (NR_Zlec)
      references ZLECENIE (NR_Zlec)
go

alter table OSNOWA
   add constraint FK_OSNOWA_GEOOSN_GEODETA foreign key (NR_Geo)
      references GEODETA (NR_Geo)
go

alter table OSNOWA
   add constraint FK_OSNOWA_OSNDZIAL_DZIALKI foreign key (NR_Dzialki)
...
alter table POMIAR
   add constraint FK_POMIAR_GEOPOM_GEODETA foreign key (NR_Geo)
      references GEODETA (NR_Geo)
go
...
alter table ZLECENIE
   add constraint FK_ZLECENIE_GEOZLEC_GEODETA foreign key (NR_Geo)
      references GEODETA (NR_Geo)
go

alter table ZLECENIE
   add constraint FK_ZLECENIE_KLIENTZLE_KLIENT foreign key (NR_Klient)
      references KLIENT (NR_Klient)
go
